...
static const std::vector<int> width({ 960,1920, 1680, 1366, 1280, 3072});
static const std::vector<int> height({ 540, 1080, 1050, 768, 800, 1920});//width / 16 * 8;
...
2048 is getting Ok
4096 is in my opinion the best
